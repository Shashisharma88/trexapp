      ...
      <div className='lg:ps-[100px] p-0 lg:pe-[151px]'>
        ...
        <div className='mb-[37px]'>
          ...
          <div className='flex gap-[28px] '>
            <label className='text-[28px] w-[200px] text-right  text-white'>Limit Per Mint</label>
            <input defaultValue={1} type="text" className=' ps-[19px]  text-[28px] h-[43px] bg-gray-300 max-w-[428px] w-full bg-opacity-0 border text-white border-white border-solid' />
          </div>
